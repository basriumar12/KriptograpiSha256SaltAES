...
package com.example.sha256withsalt.service;
...
import com.example.sha256withsalt.R;
import com.example.sha256withsalt.RegisterActivity;
...
//				.addNextIntent(new Intent(this, ActivityMain.class))
				.addNextIntentWithParentStack(new Intent(this, RegisterActivity.class))
